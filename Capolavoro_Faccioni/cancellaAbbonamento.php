...
<head>
    ...
    <title>Cancellazione Abbonamento</title>
...
<body>
    ...
    <section>
        <div class="form-box">
            <form action="" method="post">
                <h2>Cancellazione Abbonamenti</h2>
                <div class="inputbox">
    ...
    if(isset($_POST['delete'])) {
        ...
        // Preparazione della query di cancellazione per ID_Abbonamento
        $query_abbonamento = "DELETE FROM abbonamento WHERE ID_Abbonamento = '$id_abbonamento'";
        $result_abbonamento = mysqli_query($conn, $query_abbonamento);

        // Preparazione della query di cancellazione per Numero_Fattura
        
        if($result_abbonamento){
            echo "";
        }else{
            echo "";
        }
